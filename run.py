#!/home/rr/Desktop/Desktop/nex5/.venv/bin/python3
...
def main() -> None:
    ...
    # Phase 29c — DriveHistory REMOVED 2026-09-09: hourly voice_profile analyzer
    # whose output was read back only by its own state() (never registered, never
    # in AppState) — a dead loop shaping nothing. The intended voice-shaping
    # consumer was never built; module retained on disk if that is built later.
