...
launch_nex() {
  ...
  NEX5_WORLD_PRED=1 NEX5_SELF_PRED=1 NEX5_SOCIAL_N=1 NEX5_PORT=${PORT} \
  NEX5_INTAKE_RESONANCE_OFF=1 NEX5_WORLD_CONSOLIDATE=1 NEX5_L4_STAKES=1 NEX5_SELF_NARRATIVE=1 NEX5_QUALITY_SYNTH=1 NEX5_HOT_OBSERVER=1 NEX5_MOMENTUM=1 NEX5_PERSONA_RESPONDER=1 NEX5_GLOBAL_WORKSPACE=1 NEX5_SURPRISE_WEIGHT=1 NEX5_WIDE_MODES=1 NEX5_METACOG_VOICE=1 NEX5_CARRYOVER=1 NEX5_TIER_CLIMB=1 NEX5_MOOD=1 NEX5_CURIOSITY=1 NEX5_ATTRIB_CRYSTALLIZE=1 NEX5_BRANCH_TEMP=0.35 NEX5_ASSOC_RECALL=1 NEX5_STAKES_DEEP=1 NEX5_DRIVE_CONTENT=1 NEX5_VALENCE_DRIVE=1 NEX5_SOCIAL_DEPTH=1 NEX5_OPERATOR_MODEL=1 NEX5_CHAT_MEMORY=1 NEX5_COMPASSION=1 NEX5_AMOHA=1 NEX5_AFFLICTIONS=1 NEX5_COMPASS=1 NEX5_BESTOFCLUSTER=1 MOLTBOOK_DRY_RUN=0 NEX5_FOUNTAIN_DEDUP=1 NEX5_COMPASS_TRIM=1 NEX5_EQUANIMITY=1 NEX5_APRAMADA=1 NEX5_VIRYA=1 NEX5_SRADDHA=1 NEX5_PRASRABDHI=1 NEX5_AFFECT_CARRY=1 NEX5_SCORE_F2_V2=1 NEX5_FOCUS_ROTATE=1 NEX5_FRAME_DEDUP=1 NEX5_OPERATOR_ANCHOR=1 NEX5_CHAT_ANTIECHO=1 NEX5_PROVENANCE=1 ${VENV} run.py >> ${SOAK_LOG} 2>&1 &
  NEX_PID=$!
