...
_VAGUE_ENTITY_WORDS = frozenset({
    ...
    "making", "showing", "using", "show", "the", "and", "for", "cup", "world", "your", "army", "liva", "crypto", "our", "their", "us", "uk", "war", "new", "old", "top", "key", "network", "online", "system", "part", "role", "time", "way", "people", "group", "type", "five", "four", "six", "seven", "eight", "nine", "ten", "one", "two", "three", "first", "last", "next",
})
