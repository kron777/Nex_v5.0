...
| 13 | **DriveEmergence** | Emergent drives from accumulated self-same belief patterns over longitudinal history | DESIGN-REQUIRED (Phase 28-design then 29-build) | NEX5-NATIVE per SYNTHESIS_PLAN.md (§3 row 13). S5.5 DriveSystem and ExperienceMotivation rejected (wrong shape — hardcoded categories, not emergent). Already aligned with §0 by emergence framing. Design session required before implementation. |
